...
--myWorkspaces    = ["web","term","code","dev","file","social"]
--myWorkspaces    = ["I","II","III","IV","V","VI","VII","VIII","IX","X"]
--myWorkspaces = [" dev ", " www ", " sys ", " doc ", " soc ", " chat ", " mus ", " vid ", " gfx ", " term "]
...
myManageHook = composeAll . concat $
    ...
    myCFloats = ["Arandr", "Arcolinux-calamares-tool.py", "Arcolinux-tweak-tool.py", "Arcolinux-welcome-app.py", "Galculator", "feh", "mpv", "Xfce4-terminal", "zoom ", "1password"]
    myTFloats = ["Downloads", "Save As..."]
    myRFloats = []
    myIgnores = ["desktop_window"]
    my1Shifts = ["brave-browser", "slack"]
    my2Shifts = ["firefox"]
    my3Shifts = ["kitty", "Alacritty", "urxvt"]
    my4Shifts = ["code-oss"]
    my5Shifts = ["zoom"]
    my6Shifts = ["vlc", "mpv"]
    my7Shifts = []
...
myLayout = spacingRaw True (Border 0 5 5 5) True (Border 5 5 5 5) True $ avoidStruts $ mkToggle (NBFULL ?? NOBORDERS ?? EOT) $ Grid ||| tiled ||| Mirror tiled ||| ThreeColMid 1 (3/100) (1/2)
    where
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((mod1Mask, xK_d), spawn $ "rofi -show drun" )
